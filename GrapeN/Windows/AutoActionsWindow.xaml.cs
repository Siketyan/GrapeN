...
namespace GrapeN.Windows
{
    ...
    public partial class AutoActionsWindow : Window
    {
        ...
        void Add(object sender, RoutedEventArgs e)
        {
            ...
            if (Type.SelectedIndex == 4) TypeEnum = ActionType.Mute;
        ...
        void ComboBoxChanged(object sender, SelectionChangedEventArgs e)
        {
            Message.Visibility = (Type.SelectedIndex == 2 || Type.SelectedIndex == 3)
